...
public class Tablero {
    ...
    private char[][] tabla;
    private final char[][] tableroMeta = {{'1', '2', '3'}, {'4', '5', '6'}, {'7', '8', 'x'}};
    ...
    public Tablero(char[][] cs, Tablero padre) {
        this.tabla = cs;
        this.padre = padre;
    }
    ...
    public ArrayList<Tablero> getHijos() {
        ...
        if (vacio[1] > 0) {
            ...
            hijos.add(new Tablero(tableroCopia1, this));
        }
        ...
        if (vacio[1] < 2) {
            ...
            hijos.add(new Tablero(tableroCopia2, this));
        }
        ...
        if (vacio[0] > 0) {
            ...
            hijos.add(new Tablero(tableroCopia3, this));
        }
        ...
        if (vacio[0] < 2) {
            ...
            hijos.add(new Tablero(tableroCopia4, this));
        }
        return hijos;
    }
